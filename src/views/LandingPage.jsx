      ...
      <section className={styles.landing_page}>
        ...
        <section className={styles.how}>
          ...
          <div className={styles.step}>
            ...
            <p>
              Link your Spotify account to CrescendoClub. Your favorite tunes
              will become an integral part of your profile, creating a musical
          ...
          <div className={styles.step}>
            ...
            <p>
              ...
              goodbye to generic connections; CrescendoClub is where real
              musical bonds are formed.
            </p>
          </div>
          <div className={styles.step}>
            ...
            <p>
              ...
              Connect with others who vibe with the same tracks, and let the
              music be the starting point for meaningful conversations and new
              connections.
            </p>
          </div>
        </section>
